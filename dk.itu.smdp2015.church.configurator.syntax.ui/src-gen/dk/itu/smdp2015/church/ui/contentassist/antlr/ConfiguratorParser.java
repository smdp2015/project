		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParameterAccess().getGroup_3_3_3(), "rule__Parameter__Group_3_3_3__0");
					...
					put(grammarAccess.getParameterAccess().getConstraintsAssignment_3_3_3_1(), "rule__Parameter__ConstraintsAssignment_3_3_3_1");
					put(grammarAccess.getParameterAccess().getValueRangeAssignment_3_4_1(), "rule__Parameter__ValueRangeAssignment_3_4_1");
