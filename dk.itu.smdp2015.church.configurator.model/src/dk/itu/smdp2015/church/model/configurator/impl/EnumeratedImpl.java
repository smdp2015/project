 ...
 * <ul>
 *   <li>{@link dk.itu.smdp2015.church.model.configurator.impl.EnumeratedImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnumeratedImpl extends ValueRangeImpl implements Enumerated {
	/**
	...
	protected EClass eStaticClass() {
		return ConfiguratorPackage.Literals.ENUMERATED;
	}
	...
	public EList<Expression> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Expression>(Expression.class, this, ConfiguratorPackage.ENUMERATED__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConfiguratorPackage.ENUMERATED__VALUES:
