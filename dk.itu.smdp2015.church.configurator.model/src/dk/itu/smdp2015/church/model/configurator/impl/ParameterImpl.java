...
public class ParameterImpl extends AbstractParameterImpl implements Parameter {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValueRange(ValueRange newValueRange, NotificationChain msgs) {
		ValueRange oldValueRange = valueRange;
		valueRange = newValueRange;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ConfiguratorPackage.PARAMETER__VALUE_RANGE, oldValueRange, newValueRange);
	...
	public void setValueRange(ValueRange newValueRange) {
		if (newValueRange != valueRange) {
			...
			if (valueRange != null)
				msgs = ((InternalEObject)valueRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConfiguratorPackage.PARAMETER__VALUE_RANGE, null, msgs);
			if (newValueRange != null)
				msgs = ((InternalEObject)newValueRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConfiguratorPackage.PARAMETER__VALUE_RANGE, null, msgs);
			msgs = basicSetValueRange(newValueRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfiguratorPackage.PARAMETER__VALUE_RANGE, newValueRange, newValueRange));
	}
