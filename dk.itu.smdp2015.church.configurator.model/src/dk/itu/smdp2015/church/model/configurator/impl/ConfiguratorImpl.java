 ...
 * @generated
 */
public class ConfiguratorImpl extends NamedAndDescribedElementImpl implements Configurator {
	/**
	...
	public EList<AbstractParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<AbstractParameter>(AbstractParameter.class, this, ConfiguratorPackage.CONFIGURATOR__PARAMETERS);
		}
		return parameters;
	}
