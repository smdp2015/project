 ...
 * generated by Xtext
 */
package dk.itu.smdp2015.church.formatting;
...
public class ConfiguratorFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ConfiguratorGrammarAccess _configuratorGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._configuratorGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._configuratorGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._configuratorGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._configuratorGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._configuratorGrammarAccess.getML_COMMENTRule();
